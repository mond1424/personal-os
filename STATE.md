...
- branch: main
- 마지막 코드 변경: **T-27 `c3a8a83`** (2026-08-10) — ⚠️ **T-26 `25977c3`와 함께 아직 배포 전.**
  그 앞이 T-24+T-25 `05b50df` (2026-08-07) · T-23 `5ee0df6` · T-22 `2aa4237`.
...
⚠️ **배포·폰 실측 대기**: 보호 일정의 알람 예약이 그대로 만들어지는지. **화면도 동작도 안 바뀐다** —
...
✅ **확인 절차 2번은 답이 왔다 — 40%는 가운데가 답답했다. 0.2로 내렸다**(2026-08-10).
