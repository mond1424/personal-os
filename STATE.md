# STATE — 최종 갱신 2026-08-07

## 저장소
- repo: https://github.com/mond1424/personal-os
- branch: main
- 마지막 코드 변경: **T-24+T-25 `05b50df`** (2026-08-07). 그 앞이 T-23 `5ee0df6` · T-22 `2aa4237`.
...
## 기준선
typecheck 통과 / **smoke 272** / **front 256** / 실패 0 / verify exit 0
...
## 마이그레이션
최신: **`0015_me_history_reason`** — ✅ **로컬·원격 적용 + deploy 완료** (원격·배포 2026-08-06 04:40 KST)
...
> 두 번 물렸다 — "모드 하향은 라이브에 없다"(오늘 아침) · T-07의 "deploy 대기"가 일주일 넘게 남은 것.
