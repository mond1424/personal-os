...
- branch: main
- 마지막 코드 변경: **T-26 `25977c3`** (2026-08-10) — ⚠️ **아직 배포 전.**
...
## 기준선
typecheck 통과 / **smoke 279** / **front 256** / 실패 0 / verify exit 0
...
(T-26 schedule()도 넘겨받은 시계를: smoke 272→279 — 스캐너 양성 대조·`Date.now()` 대장·
 services 잔여 2건이 경과 측정·보호규칙 전제·실시각 10건·데드라인 ∓1분 7건. front 256 무변경.
