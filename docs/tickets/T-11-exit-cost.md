...
**발행** Cowork · 2026-08-01 · **담당** Codex CLI (아래 §위임 예외) · **상태** ✅ **닫힘 (2026-08-03)**

> 실측 완료 — 확인 절차 전 항목 통과. `G.state()` 넷 다 `true`인 상태에서 확인했다.
> **단, APK 설치가 서명 불일치로 삭제 후 재설치였다**(T-13). 권한은 재부여됐고
> 재확인 상태는 새 설치라 오히려 깨끗한 조건이었다.
