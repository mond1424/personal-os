...
**상태** ✅ **실측 완료 (2026-08-17 낮)** — 코드 검토 합격은 2026-08-11
실측: `intervene_sec 41 > screen_on_sec 39` — **표식이 `ACTION_SCREEN_ON`보다 2초 앞선다.**
`showOverLockScreen()` 앞에 둔 결과이고 설계대로다. 기록은 `APP-BUILD.md` §결정 기록 §낮 실측 ①.
